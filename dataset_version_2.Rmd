...
author: "Teguh Samudra, Zhuoya Wang, Henry Deng, Suguna Menon"
date: "9/15/2019"
...
```{r}
#ggplot(dataset1, aes(x = pop_density, y = no_of_bookings)) + geom_tile(aes(fill=price), color = 'white')  + scale_fill_gradient(low = "white", high = "steelblue")

ggplot(dataset1, aes(x = pop_density, y = no_of_bookings)) + geom_point()
